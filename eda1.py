...
DATASET_PATH = r"C:\Users\GANGAVARAM MAHAMMAD .LAPTOP-KRMM4FVO\Downloads\Flights123\updated_flight_dataset.csv"
...
with st.sidebar:
    ...
    logo = Image.open(r"C:\Users\GANGAVARAM MAHAMMAD .LAPTOP-KRMM4FVO\Downloads\Flights123\APP new logo (1).jpg")
...
with col1:
    ...
    flight_class = st.selectbox("🎫 SELECT CLASS", ['economy', 'business'], index=0)
...
st.markdown(
    ...
    **👨‍💻 Team Members:** Farooq | Kedar | Nissi  
    ...
    🔗 **GitHub:** [Project Repository](https://github.com/suhaneec/Airfare_Price.Predictor)  
    🌐 **Web App:** [Live Demo](https://airfare-price-predictor.streamlit.app/)  

    ---  
    *🚀 Thank you for using the **Airfare Price Predictor**! Your feedback helps us improve.*  
    """, 
    unsafe_allow_html=True
)
